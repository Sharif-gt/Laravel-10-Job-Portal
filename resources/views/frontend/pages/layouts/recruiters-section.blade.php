    ...
    <div class="container">
        <div class="text-center">
            ...
            <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Discover your
                next career move, freelance gig, or internship</p>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="swiper-slide">
                        @foreach ($recruiters as $recruiter)
                            <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a
                                    href="{{ route('companies.page', $recruiter?->slug) }}">
                                    <div class="item-logo">
                                        <div class="image-left"><img alt="joblist"
                                                src="{{ asset($recruiter?->logo) }}">
                                        </div>
                                        ...
                                        <div class="text-info-bottom mt-5"><span
                                                class="font-xs color-text-mutted icon-location">{{ $recruiter?->companyCountry?->name }}</span><span
                                                class="font-xs color-text-mutted float-end mt-5">{{ $recruiter?->jobs_count }}<span>Open
                                                    Jobs</span></span></div>
                                    </div>
                                </a>
                            </div>
