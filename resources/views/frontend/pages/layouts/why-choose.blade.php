            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="box-step step-1">
                        <h1 class="number-element wcu-icon-flex">
                            <i class="wcu-icon {{ $whyChooseUs?->icon_one }}"></i>
                        </h1>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="box-step step-2">
                        <h1 class="number-element wcu-icon-flex">
                            <i class="wcu-icon {{ $whyChooseUs?->icon_two }}"></i>
                        </h1>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="box-step border-0">
                        <h1 class="number-element wcu-icon-flex">
                            <i class="wcu-icon {{ $whyChooseUs?->icon_three }}"></i>
                        </h1>
