                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    @php
                                                                        $customPages = App\Models\CastomPage::all();
                                                                    @endphp
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <select
                                                                                ...
                                                                                <option value="/companies">Compainy Page
                                                                                </option>
                                                                                <option value="/candidates">Candidate
                                                                                    Page</option>
                                                                                <option value="/pricing">Pricing Page
                                                                                </option>
                                                                                <option value="/all-jobs">Jobs Page
                                                                                </option>
                                                                                <option value="/all-blogs">Blog Page
                                                                                </option>
                                                                                <option value="/about">About Us Page
                                                                                </option>
                                                                                <option value="/contact">Contact Us Page
                                                                                </option>
                                                                                @foreach ($customPages as $item)
                                                                                    <option
                                                                                        value="/page/{{ $item?->slug }}">
                                                                                        {{ $item?->page_name }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </label>
                                                                    </p>
